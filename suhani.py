...
bot = telebot.TeleBot('8154448514:AAEoyGqGvwjn5EuRSpKbVetCYF_Pf5TYh28')
# Admin user IDs
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /suhani command.                                                                          DM FOR GET ACCESS:- @suhani_ji")
